...
namespace ES3Types
{
    ...
    public class ES3Type_RenderTexture : ES3ObjectType
    {
        ...
        protected override void WriteObject(object obj, ES3Writer writer)
        {
            ...
            writer.WriteProperty("masterTextureLimit",QualitySettings.masterTextureLimit, ES3Type_int.Instance);
            ...
            foreach (string propertyName in reader.Properties)
            {
                switch (propertyName)
                {
                    ...
                    case "masterTextureLimit":
                        QualitySettings.masterTextureLimit = reader.Read<System.Int32>(ES3Type_int.Instance);
                        break;
